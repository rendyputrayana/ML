...
model_directory = r'C:\Users\ASUS\Desktop\Folder pengumpulan\TGS ML'
...
if(os.path.exists(model_path)):
    try:
        ...
        st.write("Aplikasi ini digunaan untuk membantu memprediksi penyait diabetes pada seseorang")
